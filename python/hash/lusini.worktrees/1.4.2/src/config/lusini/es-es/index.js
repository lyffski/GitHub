  ...
  modules: {
    cloudinary: {
      ...
      fallback_product_picture:
        'https://res.cloudinary.com/lusini/image/upload/v1643182695/application/products/lusini-online-shop-platzhalter-produktbild-in-kuerze-es.svg',
    },
    cart: {
      domain: 'lusini.com',
      fetchCartUrl:
        'https://checkout.lusini.com/es-es/CustomRequests/ajaxCartData',
      addCartItemUrl:
        'https://checkout.lusini.com/es-es/Checkout/ajaxAddArticleCart',
      removeCartItemUrl:
        'https://checkout.lusini.com/es-es/checkout/deleteArticle/sDelete/[position]/sTargetAction/cart',
      cartPixelUrl: 'https://checkout.lusini.com/es-es/checkout/cart',
      shareCartUrl: 'https://checkout.lusini.com/es-es/cart/share',
      cartRecreate: 'https://checkout.lusini.com/es-es/cartrecall/items/',
      accountUrl: 'https://checkout.lusini.com/es-es/account',
      newsletterUrl: 'https://checkout.lusini.com/es-es/newsletter',
    },
    algolia: {
