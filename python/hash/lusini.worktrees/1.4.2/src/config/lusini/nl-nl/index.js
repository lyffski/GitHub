module.exports = {
  ...
  modules: {
    ...
    cart: {
      domain: 'lusini.com',
      fetchCartUrl:
        'https://checkout.lusini.com/nl-nl/CustomRequests/ajaxCartData',
      addCartItemUrl:
        'https://checkout.lusini.com/nl-nl/Checkout/ajaxAddArticleCart',
      removeCartItemUrl:
        'https://checkout.lusini.com/nl-nl/checkout/deleteArticle/sDelete/[position]/sTargetAction/cart',
      cartPixelUrl: 'https://checkout.lusini.com/nl-nl/checkout/cart',
      shareCartUrl: 'https://checkout.lusini.com/nl-nl/cart/share',
      cartRecreate: 'https://checkout.lusini.com/nl-nl/cartrecall/items/',
      accountUrl: 'https://checkout.lusini.com/nl-nl/account',
      newsletterUrl: 'https://checkout.lusini.com/nl-nl/newsletter',
    },
    algolia: {
  ...
  features: {
    ...
    b2c: true,
    userLikeWidgetUrl:
      'https://userlike-cdn-widgets.s3-eu-west-1.amazonaws.com/558079fd8693514d87f59a4aaa74c4be4ab46b2a8ae701b438efb53fdfa3cc6b.js',
  },
}
