  ...
  modules: {
    cloudinary: {
      ...
      fallback_product_picture:
        'https://res.cloudinary.com/lusini/image/upload/v1643182695/application/products/lusini-online-shop-platzhalter-produktbild-in-kuerze-it.svg',
    },
    cart: {
      domain: 'lusini.com',
      fetchCartUrl:
        'https://checkout.lusini.com/it-it/CustomRequests/ajaxCartData',
      addCartItemUrl:
        'https://checkout.lusini.com/it-it/Checkout/ajaxAddArticleCart',
      removeCartItemUrl:
        'https://checkout.lusini.com/it-it/checkout/deleteArticle/sDelete/[position]/sTargetAction/cart',
      cartPixelUrl: 'https://checkout.lusini.com/it-it/checkout/cart',
      shareCartUrl: 'https://checkout.lusini.com/it-it/cart/share',
      cartRecreate: 'https://checkout.lusini.com/it-it/cartrecall/items/',
      accountUrl: 'https://checkout.lusini.com/it-it/account',
      newsletterUrl: 'https://checkout.lusini.com/it-it/newsletter',
    },
    algolia: {
