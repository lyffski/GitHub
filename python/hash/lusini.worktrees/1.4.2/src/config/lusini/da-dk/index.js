module.exports = {
  ...
  modules: {
    cloudinary: {
      ...
      fallback_product_picture:
        'https://res.cloudinary.com/lusini/image/upload/v1643182695/application/products/lusini-online-shop-platzhalter-produktbild-in-kuerze-da.svg',
    },
    cart: {
      domain: 'lusini.com',
      fetchCartUrl:
        'https://checkout.lusini.com/da-dk/CustomRequests/ajaxCartData',
      addCartItemUrl:
        'https://checkout.lusini.com/da-dk/Checkout/ajaxAddArticleCart',
      removeCartItemUrl:
        'https://checkout.lusini.com/da-dk/checkout/deleteArticle/sDelete/[position]/sTargetAction/cart',
      cartPixelUrl: 'https://checkout.lusini.com/da-dk/checkout/cart',
      shareCartUrl: 'https://checkout.lusini.com/da-dk/cart/share',
      cartRecreate: 'https://checkout.lusini.com/da-dk/cartrecall/items/',
      accountUrl: 'https://checkout.lusini.com/da-dk/account',
      newsletterUrl: 'https://checkout.lusini.com/da-dk/newsletter',
    },
    algolia: {
  ...
  features: {
    ...
    b2c: true,
    userLikeWidgetUrl:
      'https://userlike-cdn-widgets.s3-eu-west-1.amazonaws.com/b98b921b64b94ef4851e19255803b2f28c77bac3788f47689c7b1ae838b4eca3.js',
  },
  formApi: {
    conformityDeclaration:
      'https://getform.io/f/d182a8a1-8e5a-41b4-a48a-cc31bf98cd16',
  },
}
