module.exports = {
  ...
  modules: {
    ...
    cart: {
      domain: 'lusini.com',
      fetchCartUrl:
        'https://checkout.lusini.com/fr-ch/CustomRequests/ajaxCartData',
      addCartItemUrl:
        'https://checkout.lusini.com/fr-ch/Checkout/ajaxAddArticleCart',
      removeCartItemUrl:
        'https://checkout.lusini.com/fr-ch/checkout/deleteArticle/sDelete/[position]/sTargetAction/cart',
      cartPixelUrl: 'https://checkout.lusini.com/fr-ch/checkout/cart',
      shareCartUrl: 'https://checkout.lusini.com/fr-ch/cart/share',
      cartRecreate: 'https://checkout.lusini.com/fr-ch/cartrecall/items/',
      accountUrl: 'https://checkout.lusini.com/fr-ch/account',
      newsletterUrl: 'https://checkout.lusini.com/fr-ch/newsletter',
    },
    algolia: {
  ...
  index: {
    products: 'prod_lusini_fr_CH_products',
    productsPriceAsc: 'prod_lusini_fr_CH_products_priceAsc',
    categories: 'prod_lusini_fr_CH_categories',
    series: 'prod_lusini_fr_CH_series',
  },
  deliveryDate: {
    shippingTooLong: 150,
  },
  ...
  langShop: {
    ...
    alternate: [
      { label: 'deutsch', url: 'https://www.lusini.com/de-ch/', active: false },
      { label: 'français', url: 'https://www.lusini.com/fr-ch/', active: true },
    ],
  },
}
