...
config.modules.cart.fetchCartUrl =
  'https://checkout.lusini.dev/en/CustomRequests/ajaxCartData'
config.modules.cart.addCartItemUrl =
  'https://checkout.lusini.dev/en/Checkout/ajaxAddArticleCart'
config.modules.cart.removeCartItemUrl =
  'https://checkout.lusini.dev/en/checkout/deleteArticle/sDelete/[position]/sTargetAction/cart'
config.modules.cart.cartPixelUrl =
  'https://checkout.lusini.dev/en/checkout/cart'
config.modules.cart.shareCartUrl = 'https://checkout.lusini.dev/en/cart/share'
config.modules.cart.cartRecreate =
  'https://checkout.lusini.dev/en/cartrecall/items/'
config.modules.cart.accountUrl = 'https://checkout.lusini.dev/en/account'
config.modules.cart.newsletterUrl = 'https://checkout.lusini.dev/en/newsletter'
config.modules.cart.fetchUserStateUrl =
  'https://checkout.lusini.dev/en/widgets/userstatus'

config.features.onetrust = false
config.features.devMode = true

config.index.products = 'dev_lusini_en_products'
config.index.productsPriceAsc = 'dev_lusini_en_products_priceAsc'
