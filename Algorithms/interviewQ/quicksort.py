...
import sys
from load import load_numbers #load first my be a folder from where you can import lib, add it then to your proj folder, AND THEN, wihin this lib-forder
#you must incl. the __init__.py file for the intermpeter of pyhton, elsewise it will not work, it is just the code of conduct/protocol how pytohn intislaize
#files and lib if those arent imported
...
sorted_numbers = quicksort(numbers) # the list of nummber is on sepcate file, whihc is not here incl., creat your own array of unsorted no. to let it work
